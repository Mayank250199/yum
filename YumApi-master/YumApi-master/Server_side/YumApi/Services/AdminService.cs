...
namespace YumApi.Services
{
    ...
    {
        Task<Token> AuthenticateAdmin(string username, string password);
    ...
    public class AdminService : IAdminService
    {
        ...
        public AdminService(YumDbContext context, IConfiguration configuration)
        {
            _context = context;
        ...
        public async Task<Token> AuthenticateAdmin(string username, string password)
        {
